...
const appRouter = {
  ...
  navigateTo(targetViewId) {
    ...
    if (targetViewId === 'view-settings') {
      ...
      document.getElementById("settings-sounds").checked = localStorage.getItem("settings_sounds" + emailSuffix) !== "false";
      ...
      if (formSettings && !formSettings.dataset.bound) {
        ...
        formSettings.addEventListener("submit", (e) => {
          ...
          localStorage.setItem("settings_sounds" + suffix, sounds ? "true" : "false");
